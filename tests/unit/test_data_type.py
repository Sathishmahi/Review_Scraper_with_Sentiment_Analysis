...
from src.ReviewScraperwithSentimentAnalysis.entity.config_entity import *
...
PredictionConfig(root_dir='artifact/prediction', splited_reviews_dir_path='artifact/review_split/split_review_dir', pretrain_model_path='artifact/pretrained_model/hugging_face_model', prediction_csv_file_path='artifact/prediction/prediction.csv'), 
PretrainedModelConfig(pretrained_model_dir='artifact/pretrained_model/hugging_face_model', pretrained_model_name='roberta-large-mnli'), 
ReviewSplitConfig(root_dir='artifact/review_split', review_csv_path='artifact/data_ingestion/review.csv', battery_file_name='artifact/review_split/split_review_dir/battery.pkl', display_file_name='artifact/review_split/split_review_dir/display.pkl', camera_file_name='artifact/review_split/split_review_dir/camera.pkl', overall_file_name='artifact/review_split/split_review_dir/overall.pkl', review_split_dir_name='artifact/review_split/split_review_dir'), 
TextPreprocessingConfig(root_dir='artifact/text_preprocessing', review_file_path='artifact/data_ingestion/review.csv', processed_data_file_path='artifact/text_preprocessing/preprocess.csv', min_review_len=10), 
...
all_expected_dtypes=[DataIngestionConfig,PredictionConfig,PretrainedModelConfig,ReviewSplitConfig,TextPreprocessingConfig,
TrainingConfig]
...
class Testdtypes:
    ...
    def test_config_dtype(self):
        c=Configuration()
        all_predicted_out=[c.get_data_ingestion_config(),c.get_prediciton_config(),c.get_pretrained_config(),
        c.get_review_split_config(),c.get_text_preprocessing_config(),c.get_training_config()]
